  ...
  const statsItems = [
    {
      ...
      desc: 'Iniciado como una visión en 2019, ahora es un estado consolidado.',
    },
    {
    ...
    },
    {
      ...
      number: '100%',
      label: 'Energía ecológica',
      desc: 'Compromiso total con cero emisiones y preservación de la biosfera.',
    },
    {
