    ...
    <footer className="border-t-2 border-accent/20 bg-background py-12">
      <div className="container mx-auto px-4 md:px-0">
        <div className="grid gap-8 md:grid-cols-3 mb-10">
          {/* Logo and brand */}
          <div className="flex flex-col gap-4 md:col-span-1 items-center md:items-start">
          ...
          {/* Conócenos */}
          <div className="flex flex-col gap-3 md:col-span-1 items-center md:items-start">
          ...
          <div className="flex flex-col gap-3 md:col-span-1 items-center md:items-start">
            ...
            <div className="space-y-2 text-foreground/75 text-sm text-center md:text-left">
              <a href="/privacy" className="block transition-all duration-200 hover:text-accent md:hover:translate-x-1">Política de privacidad</a>
              <a href="/terms" className="block transition-all duration-200 hover:text-accent md:hover:translate-x-1">Términos y condiciones</a>
            </div>
          </div>
        </div>
