...
export default function Footer() {
  return (
    <footer className="relative bg-background border-t border-accent/10 py-16 overflow-hidden">
      {/* Efecto de Iluminación Ambiental (Ambient Glow) */}
      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        <div className="flex flex-col md:flex-row md:justify-between items-start gap-12 mb-16">
          ...
          <div className="flex flex-col gap-4 max-w-md w-full text-left">
            <div className="flex items-center gap-3.5 group cursor-default">
              ...
              <div>
                <p className="text-[10px] font-semibold uppercase tracking-[0.4em] text-foreground/40 leading-tight">Artis Panis</p>
                <p className="text-base font-bold uppercase tracking-[0.1em] text-foreground/90 mt-0.5">Reino del Pan</p>
              </div>
            </div>
          ...
          <div className="flex flex-wrap gap-x-16 gap-y-10 justify-between md:justify-end w-full md:w-auto">

            {/* Comunidad */}
            <div className="flex flex-col gap-4 min-w-[140px]">
              <p className="text-[11px] uppercase tracking-[0.25em] font-bold text-foreground/30">Comunidad</p>
              <div className="flex gap-2.5">
                {[
                  ...
                  <a
                    ...
                    title={social.title}
                    className={`w-9 h-9 flex items-center justify-center rounded-lg bg-foreground/[0.03] text-foreground/40 transition-all duration-300 ${social.hover} hover:scale-105 active:scale-95`}
                  >
            ...
            <div className="flex flex-col gap-3 min-w-[160px]">
              <p className="text-[11px] uppercase tracking-[0.25em] font-bold text-foreground/30">Legal</p>
              <div className="flex flex-col gap-2 items-start">
                {[
                  ...
                  <a
                    key={index}
                    href={link.href}
                    className="relative text-[13px] text-foreground/60 hover:text-foreground transition-colors duration-200 py-0.5 group"
                  >
                    {link.label}
        ...
        <div className="border-t border-accent/5 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-[11px] tracking-wide text-foreground/30 font-medium text-center sm:text-left">
            Reino del Pan © {new Date().getFullYear()} • Todos los derechos reservados.
          </p>
          <div className="flex items-center gap-1 text-[10px] tracking-[0.15em] font-bold uppercase text-foreground/20 select-none">
            <span>Est. 2025</span>
          </div>
        </div>
      </div>
