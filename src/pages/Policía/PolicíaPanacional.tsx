    ...
    return (
        <div className="min-h-screen flex flex-col bg-background text-foreground antialiased selection:bg-accent/20">
            ...
            <div className="polnac-scope font-sans-modern flex-1 flex flex-col">
                ...
                <div className="bg-zinc-900 border-b border-border/40 py-1.5 px-4 text-[10px] md:text-xs text-zinc-400 font-sans-modern">
                ...
                <header className="sticky top-0 z-50 w-full border-b border-border/60 bg-card/30 backdrop-blur-md px-4 sm:px-6 py-3 md:py-4">
                    <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-3.5 min-w-0">
                            <img
                                ...
                                alt="Logo POLNAC"
                                className="h-12 md:h-14 w-auto object-contain drop-shadow-[0_2px_8px_rgba(0,0,0,0.15)] transition-all"
                            />
                            <div className="truncate">
                                <span className="font-polnac text-xl sm:text-2xl md:text-3xl font-black tracking-tight uppercase block leading-none text-foreground truncate">
                                    Policia Nacional
                                </span>
                                <span className="text-[9px] sm:text-[10px] tracking-widest font-extrabold uppercase text-polnac-brand mt-1 block">
                                    Reino del Pan
                                </span>
                            </div>
                        </div>

                        {/* LADO DERECHO: Botón de Regresar (Integrado en el flujo) */}
                        <div className="flex items-center shrink-0">
                            <a
                                href="/"
                                className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg border border-border/60 bg-background/40 hover:bg-background/80 hover:border-foreground/20 transition-all group font-mono text-[11px] uppercase tracking-wider text-foreground/80 shadow-sm"
                            >
                ...
                {/* 3. Banner de Emergencias - FUENTE INTER EXPLICITA */}
                <div className="bg-red-950/40 border-b border-red-500/30 px-4 py-3 text-center font-sans-modern">
                    <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-center gap-2">
                        <span className="inline-flex items-center justify-center bg-red-600 text-white font-black text-xs px-2 py-0.5 rounded animate-pulse">
                            ALERTA
                        </span>
                        <p className="text-xs md:text-sm text-red-200 font-medium">
                            Si se encuentra ante una situación de emergencia inmediata, llame directamente al <strong className="text-white bg-red-700/60 px-1.5 py-0.5 rounded">112</strong> o al <strong className="text-white bg-red-700/60 px-1.5 py-0.5 rounded">99</strong>.
                        </p>
                    </div>
                </div>
                ...
                <main className="flex-1 max-w-7xl w-full mx-auto px-4 py-12 space-y-16">
                    ...
                    <section className="relative overflow-hidden rounded-2xl bg-polnac-brand p-8 md:p-12 text-center max-w-3xl mx-auto shadow-xl border border-white/10 text-white">
                        <div className="absolute top-0 right-0 p-6 opacity-10 pointer-events-none">
                            <img src="/Policía/POLNAC.png" alt="" className="w-48 h-48 object-contain" />
                        </div>
                        <h2 className="font-polnac text-3xl md:text-4xl font-bold uppercase mb-4 tracking-wide text-white">
                            Documento Personal de Identidad
                        </h2>
                        <p className="text-blue-100 text-sm md:text-base max-w-xl mx-auto mb-8 leading-relaxed font-normal">
                        ...
                        <a
                            href="/dpi/create"
                            className="inline-flex items-center justify-center text-sm font-extrabold uppercase tracking-wider bg-white text-polnac-brand hover:bg-zinc-100 px-8 py-3.5 rounded-xl transition-all shadow-lg transform hover:scale-[1.02] active:scale-100"
                        >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                        ...
                        <div className="lg:col-span-2 space-y-6">
                            ...
                            <div className="space-y-4">
                                <article className="p-5 rounded-xl border border-border/50 bg-card/40 hover:bg-card/70 transition space-y-2">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="rounded-xl border border-border bg-card p-5 space-y-5 shadow-xs">
                                <div className="text-center border-b border-border/60 pb-4">
                                    <p className="text-4xl font-black text-foreground tracking-tight">1129</p>
                                    <p className="text-xs text-muted-foreground uppercase tracking-wider font-semibold mt-1 font-subtitle">
                                ...
                                <div className="pt-4 border-t border-border/60 text-center">
                                    <p className="text-[10px] text-muted-foreground/80 font-semibold uppercase tracking-wider leading-relaxed font-subtitle">
